const contractAddress = "0xA3b9334DdA72c32b4947803955B30F28f78cBf9E"; // Replace with your own contract address
const chain = 'polygon'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to the Mr Crypto Patel NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Mr Crypto Patel NFT Project is an unique collection of 10000 NFts cretaed by Mr Lajawab. "MrCP is a man who is loaded with money, have a nice looking face and a physique like a greek god." First 5000 Nfts are availiable for sale now and another 5000 will be availiable for sale on 19-09-2022.';
